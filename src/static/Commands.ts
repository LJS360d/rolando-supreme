...
export const commands: ApplicationCommandDataResolvable[] = [
	...
	{
		name: 'hyero',
		description: 'translates the given `text` into hieroglyphs',
		options: [
			{
				name: 'text',
				description: 'The string to translate, randomly generated if omitted',
				type: 3, // String type
				required: false,
			},
		],
	...
	{
		name: 'unhyero',
		description: 'translates the hieroglyphs in `text` back to alphabet',
		options: [
			{
				name: 'text',
				description: 'The string to untranslate',
				type: 3, // String type
				required: true,
			},
		],
